...
- (NSUInteger) platformType
{
    ...
    if ([platform hasPrefix:@"iPhone6"])            return UIDevice5SPhone;
    if ([platform hasPrefix:@"iPhone7"])            return UIDevice6iPhone;
    if ([platform hasPrefix:@"iPhone8"])            return UIDevice6SPhone;
...
- (NSString *) platformString
{
    switch ([self platformType])
    {
        ...
        case UIDevice5SPhone: return IPHONE_5S_NAMESTRING;
        case UIDevice6iPhone: return IPHONE_6_NAMESTRING;
        case UIDevice6SPhone: return IPHONE_6S_NAMESTRING;
