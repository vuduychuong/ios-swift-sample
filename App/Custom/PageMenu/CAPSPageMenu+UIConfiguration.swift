    ...
    func configureUserInterface() {
        ...
        for controller in controllerArray {
            ...
            if configuration.useMenuLikeSegmentedControl {
                ...
                let itemWidth = itemWidthRect.width * 1.1
                configuration.menuItemWidth = itemWidth
                ...
                totalMenuItemWidthIfDifferentWidths += itemWidth
                menuItemWidths.append(itemWidth)
            } else {
        ...
        if menuItems.count > 0 {
            if menuItems[currentPageIndex].titleLabel != nil {
                ...
                menuItems[currentPageIndex].titleLabel!.font = configuration.menuItemSelectedFont
            }
        }
        ...
        if configuration.useMenuLikeSegmentedControl {
            ...
            selectionIndicatorFrame = CGRect(x: configuration.menuMargin, y: configuration.menuHeight - configuration.selectionIndicatorHeight, width: menuItemWidths.count > 0 ? menuItemWidths[0] : 0, height: configuration.selectionIndicatorHeight)
        } else {
